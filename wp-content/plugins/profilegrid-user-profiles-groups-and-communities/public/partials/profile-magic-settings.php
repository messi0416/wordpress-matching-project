...
<div class="pm-section pm-dbfl" id="pg-settings-container">
 ...
 <div class="pm-section-left-panel pm-section-nav-vertical pm-difl">
    ...
    <ul class="dbfl">
        <li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#pg-edit-profile"><?php _e('Account Details','profilegrid-user-profiles-groups-and-communities');?></a></li>
        <?php if($dbhandler->get_global_option_value('pm_show_change_password','1')==1):?>
        <li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#pg-change-password"><?php _e('Change Password','profilegrid-user-profiles-groups-and-communities');?></a></li>
        <?php endif;?>
         ...
         */
        /*
        if($dbhandler->get_global_option_value('pm_show_privacy_settings','0')==1):?>
        <li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#pg-privacy"><?php _e('Privacy','profilegrid-user-profiles-groups-and-communities');?></a></li>
        <?php endif;
        */
        // add by Cravel end
        ?>
        <?php if($dbhandler->get_global_option_value('pm_show_delete_profile','0')==1):?>
        <li class="pm-dbfl pm-border-bt pm-pad10"><a class="pm-dbfl" href="#pg-delete-account"><?php _e('Delete Account','profilegrid-user-profiles-groups-and-communities');?></a></li>
        <?php endif;?>
    </ul>
</div>

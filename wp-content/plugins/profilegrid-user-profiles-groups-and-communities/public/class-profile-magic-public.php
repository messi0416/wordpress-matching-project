...
class Profile_Magic_Public {
        ...
        public function profile_magic_profile_view($content)
        {
            ...
            if (is_user_logged_in()) {
                ...
                return do_shortcode("[profilegrid_login]");
            }
            // add by Cravel end
        }
...
?>
    ...
    public function pg_merge_all_scripts_header()
    {
        ...
        {
            global $wp_scripts;
            $header_Script = array('jquery-form','jcrop','jquery-effects-core','pg-profile-menu.js',$this->profile_magic,'modernizr-custom.min.js','heartbeat','profile-magic-friends-public.js','profile-magic-chat.js','profile-magic-auto-logout.js');
    ...
    public function pg_merge_all_scripts_footer()
    {
        ...
        if($enable_performance=='1')
        {
            ...
            $footer_Script = array('profile-magic-nanoscroller.js','profile-magic-tether.js','profile-magic-emoji-set.js','profile-magic-emoji-util.js','profile-magic-emojiarea.js','profile-magic-emoji-picker.js','profile-magic-footer.js','pg-password-checker.js','profile-magic-admin-power.js');
            $wp_scripts->all_deps($wp_scripts->queue);	
    ...
    public function pg_merge_all_css_footer()
    {
        ...
        {
            global $wp_styles;
            $footer_css = array('jquery-ui-styles',$this->profile_magic,'jquery.Jcrop.css','pm-emoji-picker','pm-emoji-picker-nanoscroller','pg-password-checker','pg-profile-menu','pg-dark-theme','pg-responsive',$this->pm_theme);
            ...
            foreach( $wp_styles->to_do as $handle) 
            {
                    ...
                    if  (file_exists($css_file_path)) 
                    {
                        ...
                        $merged_css .=  $localize . file_get_contents($css_file_path) . ';';
                    }
            }

                         ...
                         <div class="pm-blog-img-wrap pm-difl">
                            ...
                            <div class="pm-blog-status pm-difl">
                               <?php if($dbhandler->get_global_option_value('pm_show_user_blog_post_time','1')=='1'): 
                                 ...
                                 */
                                ?>
                                <span class="pm-blog-time "><?php printf( _x( '%s前', '%s = human-readable time difference','profilegrid-user-profiles-groups-and-communities' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span>
                               <?php
                                // Add by Cravel End
                        ...
                        <div class="pm-blog-img-wrap pm-difl">
                            ...
                            <div class="pm-blog-status pm-difl custom_sells_del_date">
                                ...
                                ?>
                                    ...
                                    echo '<ul class="custom_sells_taglist">';
                                  /* タグの取得・設定 */
                                    ...
                                    echo '<span class="tag-link-' . $tag->term_id. '">' . $tag->name . '</span>';
                                    echo '</a>';
                                    endforeach;

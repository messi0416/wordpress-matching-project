    ...
    public function get_group_page_fields_html($uid, $gid, $group_leader, $imgsize = '', $arg = '', $hide_profile_link = '')
    {
        ...
        <div class="pm-user-card pm-difl pm-border pm-radius5">
            <div class="pm-user-card-cover pm-dbfl">
                <?php
                echo $pmrequests->profile_magic_get_cover_image($uid, $imgsize, '', false, $arg); ?>
            </div>
            <div class="pm-user-image pm-dbfl pm-bg-lt <?php echo $class; ?>">
                <?php echo get_avatar($uid, $imgsize, '', false, $profile_args); ?>
            </div>
                        ...
                        switch ($field->field_type) {
                            case 'youtube':
                                ...
                                <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_' . $field->field_type; ?>">
                                    <iframe
                                        style="border:<?php if (isset($field_options['video_frame_border'])) {
                                            echo $field_options['video_frame_border'] . 'px solid';
                                        } ?>"
                                        frameborder="<?php if (isset($field_options['video_frame_border'])) {
                                            echo $field_options['video_frame_border'];
                                        } ?>"
                                        width="<?php echo ($field_options['video_width'] != '') ? $field_options['video_width'] : 640; ?>"
                                        height="<?php echo ($field_options['video_height'] != '') ? $field_options['video_height'] : 360; ?>"
                                        type="text/html"
                                        src="https://www.youtube.com/embed/<?php echo $youtube_id; ?>?mute=1&autoplay=<?php echo (isset($field_options['video_auto_play']) && $field_options['video_auto_play'] == '1') ? '1' : '0'; ?>&fs=<?php echo (isset($field_options['video_fullscreen']) && $field_options['video_fullscreen'] == '1') ? '1' : '0'; ?>&controls=<?php echo (isset($field_options['video_player_control']) && $field_options['video_player_control'] == '1') ? '1' : '0'; ?>&loop=<?php echo (isset($field_options['video_loop']) && $field_options['video_loop'] == '1') ? '1&playlist=' . $youtube_id : '0'; ?>"
                                        allowfullscreen allowautoplay></iframe>
                                </div>
                                <?php
                                break;
                            ...
                            case 'mixcloud':
                                ...
                                ?>
                                <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_' . $field->field_type; ?>">
                                    <iframe style="border:<?php echo $field_options['mixcloud_frame_border'] . 'px solid'; ?>"
                                        width="<?php echo ($field_options['mixcloud_width'] != '') ? $field_options['mixcloud_width'] : 640; ?>"
                                        height="<?php echo ($field_options['mixcloud_height'] != '') ? $field_options['mixcloud_height'] : 360; ?>"
                                        src="https://www.mixcloud.com/widget/iframe/?hide_cover=<?php if (isset($field_options['mixcloud_hide_cover'])) {
                                            echo $field_options['mixcloud_hide_cover'];
                                        } ?>&light=<?php if (isset($field_options['mixcloud_light'])) {
                                             echo $field_options['mixcloud_light'];
                                         } ?>&mini=<?php if (isset($field_options['mixcloud_mini'])) {
                                              echo $field_options['mixcloud_mini'];
                                          } ?>&hide_artwork=<?php if (isset($field_options['mixcloud_hide_artwork'])) {
                                               echo $field_options['mixcloud_hide_artwork'];
                                           } ?>&autoplay=<?php if (isset($field_options['mixcloud_auto_play'])) {
                                                echo $field_options['mixcloud_auto_play'];
                                            } ?>&feed=<?php echo $feed; ?>"
                                        frameborder="<?php echo $field_options['mixcloud_frame_border']; ?>" allow="autoplay"></iframe>
                                </div>
                                <?php
                                break;
                            ...
                            case 'instagram':
                                ?>
                                <div class="pm-card-value pm-difl <?php echo 'pm_collapsable_' . $field->field_type; ?>"><a
                                        href="<?php echo $value; ?>" target="_blank">
                                        <?php echo $value; ?>
                                    </a></div>
                                <?php
                                break;
        ...
        if ($pagenum <= $num_of_pages) {
                        ...
                        <div class="pm-blog-img-wrap pm-difl">
                            ...
                            <div class="pm-blog-status pm-difl">
                                <?php if ($dbhandler->get_global_option_value('pm_show_user_blog_post_time', '1') == '1'):
                                     ...
                                     * 日付の表示を調整
                                     * 
                                     * 'ago' がハードコーディングされていたので '前' に変更
                                     */
                                    ?>
                                    <span class="pm-blog-time ">
                                        <?php printf(_x('%s前', '%s = human-readable time difference', 'profilegrid-user-profiles-groups-and-communities'), human_time_diff(get_the_time('U'), current_time('timestamp'))); ?>
                                    </span>
                                    <?php
                                    // Add by Cravel End
                                ...
                                <?php if ($dbhandler->get_global_option_value('pm_show_user_blog_post_comment_count', '1') == '1'): ?>
                                    <span class="pm-blog-comment">
                                        <?php comments_number(__('no Comment', 'profilegrid-user-profiles-groups-and-communities'), __('1 Comment', 'profilegrid-user-profiles-groups-and-communities'), __('% Comments', 'profilegrid-user-profiles-groups-and-communities')); ?>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            if ($pagenum < $num_of_pages):
                ...
                <div class="pg-load-more-container pm-dbfl">
                    ...
                    <input type="submit" class="pm-load-more-blogs" onclick="load_more_pg_blogs('<?php echo $uid; ?>')"
                        value="<?php _e('Load More', 'profilegrid-user-profiles-groups-and-communities'); ?>" />
                </div>
                <?php
            endif;
    ...
    public function pm_get_user_messenger($receiver_uid)
    {
        ...
        <div class="pm-group-view">
            <div class="pm-section pm-dbfl">
                <svg onclick="show_pg_section_left_panel()" class="pg-left-panel-icon" fill="#000000" height="24"
                ...
                <div class="pm-section-left-panel pm-section-nav-vertical pm-difl " id="thread_pane">
                    ...
                    <div class="dbfl pm-new-message-area"><a title="Click here to compose the message" id="new_message_btn"
                            onclick="create_new_message()"><i class="fa fa-plus" aria-hidden="true"></i>
                ...
                <div class="pm-section-right-panel">
                    <div class="pm-blog-desc-wrap pm-difl pm-section-content pm-message-thread-section">
                        <div id="pm-msg-overlay" class="pm-msg-overlay  <?php if (
                            ($return == " You have no conversations yet.")
                            && !isset($receiver_user)
                        )
                            echo "pm-overlay-show1" ?>"> </div>
                            <form id="chat_message_form" onsubmit="pm_messenger_send_chat_message(event);">
                                <div class="pm-user-display-area pm-dbfl ">
                                    ...
                                    <div class="pm-user-send-box pm-difl">
                                        <input type="text" id="receipent_field" value="<?php if (isset($receiver_user))
                            echo " @" . $receiver_user['name']; ?>" placeholder="@Username"
                                    style="min-width: 100%;" onblur="pm_get_rid_by_uname(this.value)"/>
                                    <input type="hidden" id="receipent_field_rid" name="rid" value="<?php if (isset($receiver_user))
                                        echo $receiver_user['uid']; ?>" />
                                </div>
                            </div>

                            <div id="pm-autocomplete"></div>
                            <div id="pm-username-error" class="pm-dbfl"></div>
                            <div id="message_display_area" class="pm-difl pm_full_width_profile"
                                style="min-height:200px;max-height:200px;max-width: 550px;overflow-y:auto;">
                            ...
                            <div id="typing_on" class="pm-user-description-row pm-dbfl pm-border">
                                <div class="pm-typing-inner"><img height="9px" width="40px" src="<?php echo $path; ?>" /></div>
                            </div>
                            ...
                            <div class="pm-dbfl pm-chat-messenger-box">
                                ...
                                <div class="emoji-container">
                                    <div class="pm-messenger-user-profile-pic">
                                        <?php $avatar = get_avatar($current_user->ID, 50, '', false, array('class' => 'pm-user-profile', 'force_display' => true));
                                        echo $avatar;
                                        ?>
                                    </div>
                                    <textarea id="messenger_textarea" data-emojiable="true" name="content"
                                        style="min-width: 100%;height:100px;" form="chat_message_form" placeholder="<?php _e("
                                Type your message..", "profilegrid-user-profiles-groups-and-communities");
                                        ?>" ></textarea>
                                    <input type="hidden" disabled maxlength="4" size="4" value="1000" id="counter">
                                    <input type="hidden" name="sid" value="" />
                                    <div class="pm-messenger-button">
                                        <label>
                                            <input id="send_msg_btn" type="submit" name="send" value="<?php _e("
                                        send", "profilegrid-user-profiles-groups-and-communities"); ?>"/>
                                            <svg width="100%" height="100%" viewBox="0 0 512 512" version="1.1"
                                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                xml:space="preserve" style="fill:#ccc">
                                                <g
                                                    transform="matrix(1.05995e-15,17.3103,-17.3103,1.05995e-15,22248.8,-22939.9)">
                                                    <path
                                                        d="M1340,1256C1340,1256 1350.4,1279.2 1352.6,1284.1C1352.68,1284.28 1352.65,1284.49 1352.53,1284.65C1352.41,1284.81 1352.22,1284.89 1352.02,1284.86C1349.73,1284.54 1344.07,1283.75 1342.5,1283.53C1342.26,1283.5 1342.07,1283.3 1342.04,1283.06C1341.71,1280.61 1340,1268 1340,1268C1340,1268 1338.33,1280.61 1338.01,1283.06C1337.98,1283.31 1337.79,1283.5 1337.54,1283.53C1335.97,1283.75 1330.28,1284.54 1327.98,1284.86C1327.78,1284.89 1327.58,1284.81 1327.46,1284.65C1327.35,1284.49 1327.32,1284.28 1327.4,1284.1C1329.6,1279.2 1340,1256 1340,1256Z" />
                                                </g>
                                            </svg>
                                        </label>
                                    </div>
...
<div class="pm-friend-action-bar pm-dbfl">
    <button class="pm-difr pm-delete" onclick="pm_multiple_friends_remove('<?php echo $u1; ?>')">
        <?php _e('Remove', 'profilegrid-user-profiles-groups-and-communities'); ?>
    </button>
</div>
<?php
                                break;
            case 2:
                ?>
<div class="pm-friend-action-bar pm-dbfl">
    <button class="pm-difr pm-delete" onclick="pm_multiple_friends_request_delete('<?php echo $u1; ?>')">
        <?php _e('Delete', 'profilegrid-user-profiles-groups-and-communities'); ?>
    </button>
    <button class="pm-difr " onclick="pm_multiple_friends_request_accept('<?php echo $u1; ?>')">
        <?php _e('Accept', 'profilegrid-user-profiles-groups-and-communities'); ?>
    </button>
</div>
<?php
                                break;
            case 3:
                ?>
<div class="pm-friend-action-bar pm-dbfl">
    <button class="pm-difr pm-delete" onclick="pm_multiple_friends_request_cancel('<?php echo $u1; ?>')">
            ...
            <div class="pm-field-input">
                <div class="pmradio">
                    <div class="pm-radio-option">
                        <input type="radio" name="pm_blog_select_type" id="pm_blog_select_type" value="this_page"
                            checked="checked">
...
<div class="pg-group-setting-popup-footer pm-dbfl">
    <div class="pg-group-setting-bt pm-difl"><a onclick="pg_select_blog_posts()">
            <?php _e('Select', 'profilegrid-user-profiles-groups-and-communities'); ?>
        </a></div>
    <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
            class="pm-remove">
            <?php _e('Cancel', 'profilegrid-user-profiles-groups-and-communities'); ?>
        </a></div>
</div>
...
<form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_change_post_status_form"
    id="pg_change_post_status_form">
    <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
        <div class="pmrow">
            <div class="pm-col">
                ...
                <div class="pm-field-input">
                    <div class="pmradio">
                        <div class="pm-radio-option">
                            <input type="radio" name="pm_change_blog_status" id="pm_change_blog_status" value="publish"
                                <?php checked('publish', $post_status); ?>>
                            <?php _e('Published', 'profilegrid-user-profiles-groups-and-communities'); ?>
                        </div>
                        <div class="pm-radio-option">
                            <input type="radio" name="pm_change_blog_status" id="pm_change_blog_status" value="pending"
                                <?php checked('pending', $post_status); ?>>
                            <?php _e('Pending Review', 'profilegrid-user-profiles-groups-and-communities'); ?>
                        </div>
                        <div class="pm-radio-option">
                            <input type="radio" name="pm_change_blog_status" id="pm_change_blog_status" value="draft"
                                <?php checked('draft', $post_status); ?>>
                            <?php _e('Draft', 'profilegrid-user-profiles-groups-and-communities'); ?>
                        </div>
    ...
    <div class="pg-group-setting-popup-footer pm-dbfl">
        <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_status()">
                <?php _e('Update', 'profilegrid-user-profiles-groups-and-communities'); ?>
            </a></div>
        <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
                class="pm-remove">
                <?php _e('Cancel', 'profilegrid-user-profiles-groups-and-communities'); ?>
...
<div class="pg-group-setting-popup-footer pm-dbfl">
    <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
            class="pm-remove">
            <?php _e('Close', 'profilegrid-user-profiles-groups-and-communities'); ?>
        </a></div>
</div>
...
<form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_change_post_content_access_level"
    id="pg_change_post_content_access_level">
    <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
        ...
        <div class="pmrow">
            <div class="pm-col">
                ...
                <div class="pm-field-input">
                    <div class="pmradio">
                        <div class="pm-radio-option">
                            <input type="radio" name="pm_content_access" id="pm_content_access-rtest" value="1" <?php
                            checked('1', $pm_content_access); ?>/>
                            <label>
                                <?php _e('Public', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>
                        <div class="pm-radio-option">
                            <input type="radio" name="pm_content_access" id="pm_content_access" value="2" <?php
                            checked('2', $pm_content_access); ?> />
                            <label>
                                <?php _e('Logged In Users', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>

                        <div class="pm-radio-option">
                            <input type="radio" name="pm_content_access" id="pm_content_access" value="5" <?php
                            checked('5', $pm_content_access); ?> />
                            <label>
                                <?php _e('Only Group Members', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>

                        <div class="pm-radio-option">
                            <input type="radio" name="pm_content_access" id="pm_content_access" value="3" <?php
                            checked('3', $pm_content_access); ?> />
                            <label>
                                <?php _e("Only Author's Friends", 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_access_content()">
                        <?php _e('Update', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
                        class="pm-remove">
    ...
    public function edit_blog_post_popup($post_id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_edit_blog_post" id="pg_edit_blog_post">
                    ...
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-lable pm-difl">
                            <label for="blog_title">
                                <?php _e('Title', 'profilegrid-user-profiles-groups-and-communities'); ?><sup
                                    class="pm_estric">*</sup>
                            </label>
                        </div>
                        <div class="pm-field-input pm_required pm-difl">
                            <input title="Enter your title" type="text" class="" maxlength="" value="<?php if (isset($post)) {
                    ...
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-lable pm-difl">
                            <label for="blog_description">
                                <?php _e('Description', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_edit_blog_post()">
                        <?php _e('Update', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
                        class="pm-remove">
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_add_admin_note" id="pg_add_admin_note">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow">
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-lable pm-difl">
                            <label for="pm_admin_note_content">
                                <?php _e('Content', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>
                        <div class="pm-field-input pm-difl">
                            <textarea name="pm_admin_note_content" id="pm_admin_note_content" maxlength="5000" size="5000"
                                onkeyup="pg_count_left_charactors('pm_admin_note_content','pg_text_counter','{CHAR} <?php _e('characters left', 'profilegrid-user-profiles-groups-and-communities'); ?>','5000')"><?php if (isset($pm_admin_note_content))
                                       echo $pm_admin_note_content; ?></textarea>
                            <div class="errortext" style="display:none;"></div>
                            <div id="pg_text_counter">
                                <?php _e(sprintf('%d characters left', $char_limit), 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </div>
                        </div>
                    ...
                    <div class="pg-users-send-box pm-dbfl">
                        <div class="pm-field-lable pm-difl">
                            <label for="pm_admin_note_position">
                                <?php _e('Position:', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>
                        <div class="pm-field-input pm-difl">
                            <div class="pmradio">
                                <div class="pm-radio-option pm-difl">
                                    <input type="radio" name="pm_admin_note_position" id="pm_admin_note_position" value="top"
                                        <?php checked('top', $pm_admin_note_position);
                                        if ($pm_admin_note_position == '')
                                            echo 'checked'; ?>/>
                                    <?php _e('Top', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                </div>
                                <div class="pm-radio-option pm-difl">
                                    <input type="radio" name="pm_admin_note_position" id="pm_admin_note_position" value="bottom"
                                        <?php checked('bottom', $pm_admin_note_position); ?> />
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <?php if ($char_limit == '5000') { ?>
                    <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_admin_note_content()">
                            <?php _e('Add', 'profilegrid-user-profiles-groups-and-communities'); ?>
                        </a></div>
                    <?php
                } else { ?>
                    <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_post_admin_note_content()">
                    ...
                    <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_delete_admin_note_content()">
                            <?php _e('Delete', 'profilegrid-user-profiles-groups-and-communities'); ?>
                        </a></div>
    ...
    public function delete_admin_note_popup($postid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_delete_admin_note"
            id="pg_delete_admin_note">
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_delete_admin_note()">
                        <?php _e('Yes', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
                        class="pm-remove">
                        <?php _e('No', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
            </div>
    ...
    public function send_message_to_author_popup($post_id, $gid, $type = 'blog')
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_send_author_message"
            id="pg_send_author_message">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow">
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-lable pm-difl">
                            <label>
                                <?php _e('To:', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>
                        <div class="pm-field-input pm-difl">
                            <span class="pm-message-username">
                                <?php echo '@' . $username; ?>
                            </span>
                            <?php if ($first_name != '' && $last_name != ''): ?>
                                <span class="pm-message-dn">(
                ...
                <div class="pmrow">
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-lable pm-difl">
                            <label for="pm_author_message">
                                <?php _e('Message:', 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </label>
                        </div>
                        <?php if ($type == 'blog'): ?>
                            <div class="pm-field-input pm-difl">
                                <textarea name="pm_author_message"
                                    id="pm_author_message"><?php _e(sprintf('About your blog post: %s', $post->post_title), 'profilegrid-user-profiles-groups-and-communities'); ?></textarea>
                                <div class="errortext" style="display:none;"></div>

                            </div>
                        <?php else: ?>
                            <div class="pm-field-input pm-difl">
                                <textarea name="pm_author_message" id="pm_author_message"
                                    placeholder="<?php _e('Type your message here', 'profilegrid-user-profiles-groups-and-communities'); ?>"></textarea>
                                <div class="errortext" style="display:none;"></div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_submit_author_message()">
                        <?php _e('Send', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
                        class="pm-remove">
                        <?php _e('Cancel', 'profilegrid-user-profiles-groups-and-communities'); ?>
    ...
    public function add_user_in_group_popup($gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_add_user" id="pg_add_user">
                    ...
                    <div class="group-popup-container">
                        <div class="pm-field-input pm-pad10 pm-dbfl">
                            <div class="pm_repeat pm-pad10">
                                <input type="email" id="pm_email_address" name="pm_email_address[]"
                                    placeholder="Enter Email Address" value="">
                                <a class="pg-add-user"><span onClick="pm_add_repeat(this)">
                                        <?php _e('Add More', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                    </span></a><a class="pg-remove-user pm-remove"><span class="remove"
                                        onClick="pm_remove_repeat(this)">
                                        <?php _e('Remove', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                    </span></a>
                                <div class="errortext" style="display:none;"></div>
                            </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pg_invite_user()">
                        <?php _e('Invite', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a onclick="pg_edit_popup_close()"
                        class="pm-remove">
                        <?php _e('Cancel', 'profilegrid-user-profiles-groups-and-communities'); ?>
    ...
    public function invitation_send_result_success_popup($result)
    {
        ...
        <div class="pg-group-setting-popup-footer pm-dbfl">
            <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                    onclick="pg_edit_popup_close()">
                    <?php _e('Close', 'profilegrid-user-profiles-groups-and-communities'); ?>
                </a></div>
        </div>
    ...
    public function remove_user_in_group_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_remove_user_in_group"
            id="pg_remove_user_in_group">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow">
                    <div class="pm-col">
                        <?php
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_remove_user_from_group()">
                        <?php _e('Yes', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
    ...
    public function remove_admin_in_group_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_remove_admin" id="pg_remove_admin">
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_remove_admin_from_group()">
                        <?php _e('Yes', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
    ...
    public function deactivate_user_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_deactivate_user_in_group"
            id="pg_deactivate_user_in_group">
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_deactivate_user_from_group()">
                        <?php _e('Yes', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
    ...
    public function reset_password_user_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_reset_user_password"
            id="pg_reset_user_password">
            ...
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                ...
                <div class="pmrow">
                    ...
                    <div class="group-popup-container">
                        <div class="pm-field-input">
                            <input type='password' id='pm_new_pass' name='pm_new_pass'
                                placeholder="<?php _e('Enter New Password', 'profilegrid-user-profiles-groups-and-communities'); ?>"
                                onkeyup="pg_check_password_strenth()" />
                        ...
                        <div class="pm-field-input pm-dbfr">
                            <a onclick="pg_password_auto_generate('pm_new_pass')">
                                <?php _e('Autogenerate'); ?>
                            </a>
                        </div>
                        ...
                        <div class="pg-email-password pm-dbfl">
                            ...
                            <div class="pm-field-input">
                                <label for="pm_email_password_to_user">
                                    <input type="checkbox" name="pm_email_password_to_user" id="pm_email_password_to_user"
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a id="pm_member_reset_password_link" class="pg-setting-disabled">
                        <?php _e('Reset', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
                        <?php _e('Cancel', 'profilegrid-user-profiles-groups-and-communities'); ?>
                ...
                <div class="pmrow">
                    <div class="pm-col">
                        ...
                        <div class="pm-field-input">
                            <div class="pmradio">
                                <div class="pm-radio-option">
                                    <input type="radio" name="pm_content_access" id="pm_post_access_public" value="1" <?php
                                    checked('1', $pm_content_access); ?>/>
                                    <label for="pm_post_access_public">
                                        <?php _e('Public', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                    </label>
                                </div>
                                <div class="pm-radio-option">
                                    <input type="radio" name="pm_content_access" id="pm_post_access_logged-in-users" value="2"
                                        <?php checked('2', $pm_content_access); ?> />
                                    <label for="pm_post_access_logged-in-users">
                                        <?php _e('Logged In Users', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                    </label>
                                </div>

                                <div class="pm-radio-option">
                                    <input type="radio" name="pm_content_access" id="pm_post_access-group-member" value="5"
                                        <?php checked('5', $pm_content_access); ?> />
                                    <label for="pm_post_access-group-member">
                                        <?php _e('Only Group Members', 'profilegrid-user-profiles-groups-and-communities'); ?>
                                    </label>
                                </div>

                                <div class="pm-radio-option">
                                    <input type="radio" name="pm_content_access" id="pm_post_access-user-friends" value="3"
                                        <?php checked('3', $pm_content_access); ?> />
                                    <label for="pm_post_access-user-friends">
                                        <?php _e("Only Author's Friends", 'profilegrid-user-profiles-groups-and-communities'); ?>
                                    </label>
                                </div>
                ...
                <div class="pmrow ">
                    <div class="pg-users-send-box pm-dbfl">
                        ...
                        <div class="pm-field-input pm-difl">
                            ...
                            <div class="errortext" style="display:none;"></div>
                            <div id="pg_text_counter">
                                <?php _e(sprintf('<b>%d</b> characters left', $char_limit), 'profilegrid-user-profiles-groups-and-communities'); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    public function pg_remove_group_in_user_profile_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_remove_group_in_user_profile"
            id="pg_remove_group_in_user_profile">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow">
                    <?php if ($is_leader): ?>
                        <div class="pm-col">
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a
                        onclick="pg_remove_user_group('<?php echo esc_attr($id); ?>','<?php echo esc_attr($gid); ?>')">
                        <?php _e('Yes', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
    ...
    public function pg_decline_request_to_join_group_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_decline_request_to_join_group"
            id="pg_decline_request_to_join_group">
            <div class="pm-dbfl pm-pad10 pg-group-setting-popup-wrap">
                <div class="pmrow">
                    <div class="pm-dbfl pg-info-message">
                        <?php
                            ...
                            <div class="pg-group-user-info pm-dbfl">
                                ...
                                <div class="pm-difr">
                                    <div class="pg-group-user-view-link pm-difr">
                                        <a href="<?php echo $pm_request->pm_get_user_profile_url($user->ID) ?>" target="_blank">
                                            <?php _e('View Profile'); ?>
                                        </a>
                                    </div>
                                </div>
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a
                        onclick="pg_decline_join_request('<?php echo esc_attr($id); ?>','<?php echo esc_attr($gid); ?>')">
                        <?php _e('Decline', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
                        <?php _e('Cancel', 'profilegrid-user-profiles-groups-and-communities'); ?>
    ...
    public function pg_accept_request_to_join_group_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_decline_request_to_join_group"
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a
                        onclick="pg_approve_join_request('<?php echo esc_attr($id); ?>','<?php echo esc_attr($gid); ?>')">
                        <?php _e('Approve', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
                        <?php _e('Cancel', 'profilegrid-user-profiles-groups-and-communities'); ?>
        ...
        <div class="pmagic">
            <div class="pg-group-payment-form">
                <form method="post" class="pmagic-form pm-dbfl">
                    <fieldset>
                        <legend>
                            <?php _e('Payment', 'profilegrid-user-profiles-groups-and-communities'); ?>
                        </legend>
                    ...
                    <div class="buttonarea pm-full-width-container">
                        <input type="submit" name="pg_join_paid_group_form" id="pg_join_paid_group_form" class="pm_button"
                            value="<?php _e('Join Group', 'profilegrid-user-profiles-groups-and-communities'); ?>" />
                    </div>
                </form>
            </div>
        </div>
    ...
    public function pg_decline_request_bulk_to_join_group_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_decline_bulk_join_group_requests"
            id="pg_decline_bulk_join_group_requests">
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_decline_bulk_join_group_requests()">
                        <?php _e('Decline', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
    ...
    public function pg_accept_request_bulk_to_join_group_popup($id, $gid)
    {
        ...
        <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" name="pg_decline_bulk_join_group_requests"
            ...
            <div class="pg-group-setting-popup-footer pm-dbfl">
                <div class="pg-group-setting-bt pm-difl"><a onclick="pm_approve_bulk_join_group_requests()">
                        <?php _e('Approve', 'profilegrid-user-profiles-groups-and-communities'); ?>
                    </a></div>
                <div class="pg-group-setting-bt pg-group-setting-close-btn pm-difl"><a class="pm-remove"
                        onclick="pg_edit_popup_close()">
    ...
    public function pm_get_user_blogs_shortcode_posts($author, $post_type, $pagenum = 1, $limit = 10)
    {
        ...
        if ($pagenum <= $num_of_pages) {
          ...
          while ($query->have_posts()){
              $query->the_post();
              $validate = true;
              if(isset($_REQUEST['price']) || isset($_REQUEST['first_none'])){
                $validate = mes_search_verify();
              }
              ...
              <div class="pm-blog-post-wrap pm-dbfl">
                  <div class="pm-blog-img-wrap pm-difl">
                      <div class="pm-blog-img pm-difl custom_sells_del_img">
                          <?php if (has_post_thumbnail()) {
                              the_post_thumbnail('post-thumbnail');
                          } else { ?>
                              <img src="<?php echo $path; ?>" alt="<?php the_title(); ?>" class="pm-user" />
                      ...
                      <div class="pm-blog-status pm-difl custom_sells_del_date">
                          <!-- mes-stop-back -->
                          <?php
                          // Add by Cravel Start
                          /**
                  ...
                  <div class="custom_sells_head">
                      <?php
                      echo '<div class="custom_sells_date">' . get_the_date() . '</div> ';
                      the_tags('<ul class="custom_sells_taglist"><span>', '</span><span>', '</span></ul>');
                      // mes-stop-permalink
                      ?>
                  </div>
                  <div class="pm-blog-desc-wrap pm-difl">
          ...
          if ($pagenum < $num_of_pages){
              ?>
                  <div class="pg-load-more-container pm-dbfl">
                      <div class="pm-loader" style="display:none;"></div>
                      <input type="hidden" id="pg_next_blog_page" value="<?php echo $pagenum + 1; ?>" />
                      <input type="submit" class="pm-load-more-blogs"
                          onclick="load_more_user_blogs_shortcode_posts('<?php echo $authors; ?>','<?php echo $posttypes; ?>')"
                          value="<?php _e('Load More', 'profilegrid-user-profiles-groups-and-communities'); ?>" />
                  </div>
                  <?php
          }
                ...
                <div class="pm-section pm-dbfl">
                    ...
                    <div class="pm-section-left-panel pm-section-nav-vertical pm-difl " id="thread_pane">
                        ...
                        <div class="dbfl pm-new-message-area">
                            <div class="pm-user-display-area pm-dbfl ">
                                <div class="pm-user-send-to pm-difl">To</div>
                                <div class="pm-user-send-box pm-difl">
                                    <input type="text" id="receipent_field" autocomplete="off" value="<?php if (isset($receiver_user))
                                        echo $receiver_user['name']; ?>" placeholder="Username"
                                        style="min-width: 100%;" onblur="pm_get_rid_by_uname(this.value)" />
                                    <input type="hidden" id="receipent_field_rid" name="rid" value="<?php if (isset($receiver_user))
                                        echo $receiver_user['uid']; ?>" />
                    ...
                    <div class="pm-section-right-panel">
                        ...
                        yet.") && !isset($receiver_user)
                                ...
                                <div id="typing_on" class="pm-user-description-row pm-dbfl pm-border">
                                    <div class="pm-typing-inner"><img height="9px" width="40px" src="<?php echo $path; ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="pm-dbfl pm-chat-messenger-box">
                                    ...
                                    <div class="emoji-container">
                                        ...
                                        <textarea id="messenger_textarea" data-emojiable="true" name="content"
                                            style="min-width: 100%;height:100px;" form="chat_message_form"
                                            placeholder="<?php _e(" Type your
                                    message..", "profilegrid-user-profiles-groups-and-communities"); ?>" ></textarea>
                                        <input type="hidden" disabled maxlength="4" size="4" value="1000" id="counter">
                                        <input type="hidden" name="sid" value="" />
                                        <div class="pm-messenger-button">
                                            <label>
